...
import javapersistence.exceptions.NonexistentEntityException;
import javapersistence.exceptions.PreexistingEntityException;
...
public class EmpleadosJpaController implements Serializable {
    ...
    public void create(Empleados empleados) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findEmpleados(empleados.getNumemp()) != null) {
    ...
    public void edit(Empleados empleados) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = empleados.getNumemp();
