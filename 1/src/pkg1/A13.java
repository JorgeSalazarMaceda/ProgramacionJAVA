...
public class A13 {
    ...
    public static void main(String[] args) {
        ...
        numero = leer.nextInt();
        while (intentos <= 10 && numero != aleatorio) {
        ...
        //No cogerá la multiplicación por 100 y con el casting de int dará por bueno 0 porque machaca los decimales. Le ponemos +1 porque así tenemos el máximo
